                ...
                Row(
                  ...
                  children: [
                    ...
                    BlocBuilder<FavoritesBloc, FavoritesState>(builder: (context, favState) {
                      ...
                      final isFav = favs.any((f) => f.productId == productId);
                      return IconButton(
                        icon: Icon(
                        ...
                        onPressed: () {
                          if (isFav) {
                            context.read<FavoritesBloc>().add(RemoveFavoriteEvent(productId));
                          } else {
                            context.read<FavoritesBloc>().add(AddFavoriteEvent(productId, flight!.flightNumber));
                          }
                        },
                      );
                    })
