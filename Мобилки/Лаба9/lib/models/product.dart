...
class Flight extends HiveObject {
  ...
  String get duration {
    try {
      final depTime = int.parse(departureTime.split(':')[0]); //получаем час вылета
      final arrTime = int.parse(arrivalTime.split(':')[0]); //получаем час прилёта
      final diff = (arrTime - depTime + 24) % 24;
      return '${diff}h'; //преобразование числа в строку
    } catch (e) {
      return 'N/A';
    }
  }
